...
import { watchmanLogin } from '../Services/apiService';
...
const WatchmanLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      await watchmanLogin(email, password); // Attempt to login
      navigate('/watchman_landing'); // Redirect on successful login
    } catch (err) {
